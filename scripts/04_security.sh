...
grant_role "$INGEST_SA" "roles/spanner.databaseUser"
...
# Security (auto-generated by 04_security.sh)
export RAG_SA="${RAG_SA}"
export INGEST_SA="${INGEST_SA}"
export EVAL_SA="${EVAL_SA}"
export CICD_SA="${CICD_SA}"
export KEYRING_NAME="${KEYRING_NAME}"
export DATA_KEY="${DATA_KEY}"
export SIGN_KEY="${SIGN_KEY}"
export ATTESTOR_ID="${ATTESTOR_ID}"
ENVEOF
