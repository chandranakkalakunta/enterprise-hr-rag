...
cat >> "${SCRIPT_DIR}/../config/common.env" << ENVEOF

# Organization (auto-generated by 01_org_setup.sh)
export ORG_ID="${ORG_ID}"
export ROOT_FOLDER_ID="${ROOT_ID}"
export DEV_FOLDER_ID="${DEV_ID}"
export PROD_FOLDER_ID="${PROD_ID}"
export SHARED_FOLDER_ID="${SHARED_ID}"
ENVEOF
